#############################################################################
# Makefile for building: structTest
# Generated by qmake (3.1) (Qt 6.6.2)
# Project:  structTest.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile structTest.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = structTest1.0.0
DISTDIR = /media/gregor/SD\ 128GB/qt/structTestBSv2/.tmp/structTest1.0.0
LINK          = g++
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		structTest.pro bubble.h \
		error.h \
		mainwindow.h \
		swapper.h bubble.cpp \
		error.cpp \
		main.cpp \
		mainwindow.cpp \
		swapper.cpp
QMAKE_TARGET  = structTest
DESTDIR       = 
TARGET        = structTest
...
structTest: ui_error.h ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: structTest.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile structTest.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents bubble.h error.h mainwindow.h swapper.h $(DISTDIR)/
	$(COPY_FILE) --parents bubble.cpp error.cpp main.cpp mainwindow.cpp swapper.cpp $(DISTDIR)/
	$(COPY_FILE) --parents error.ui mainwindow.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_error.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_error.cpp moc_mainwindow.cpp
moc_error.cpp: error.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include '/media/gregor/SD 128GB/qt/structTestBSv2/moc_predefs.h' -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I'/media/gregor/SD 128GB/qt/structTestBSv2' -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/14 -I/usr/include/x86_64-linux-gnu/c++/14 -I/usr/include/c++/14/backward -I/usr/lib/gcc/x86_64-linux-gnu/14/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include error.h -o moc_error.cpp
...
compiler_uic_make_all: ui_error.h ui_mainwindow.h
compiler_uic_clean:
	-$(DEL_FILE) ui_error.h ui_mainwindow.h
ui_error.h: error.ui \
		/usr/lib/qt6/libexec/uic
	/usr/lib/qt6/libexec/uic error.ui -o ui_error.h
...
swapper.o: swapper.cpp swapper.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o swapper.o swapper.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/structTest/bin || mkdir -p $(INSTALL_ROOT)/opt/structTest/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/structTest/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/structTest/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/structTest/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/structTest/bin/ 
